...
def nova_conta(cpf):
    ...
    for valor in cpf_list:
        if valor == cpf:
            conta_cliente.append(f"Conta cadastrada para Cliente com CPF: {cpf}")
            conta_cliente.append(f"Numero da conta: {n_conta}")
            conta_cliente.append(f"Agência: {agencia}")
